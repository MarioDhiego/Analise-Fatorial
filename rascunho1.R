...
:::
  ...
  ## **Principais Etapas para Aplicação - AF**
...
:::
  ...
  ## **Métodos de Escolha do Número de Fatores**
...
:::
  ...
  ## **Tamanho de Amostra para Aplicação da AF**
...
:::
  ...
  ## **Métodos de Estimação dos Escores Fatoriais**
...
:::
  ...
  ## **Viabilidade da Análise de Fatores**
